document.addEventListener("DOMContentLoaded", function () {
    try {
        ...
        // Desktop-specific animations (768px or greater only)
        ...
        // Mobile-specific animations (less than 768px)
        matchMedia.add("(max-width: 767px)", () => {
            console.log("Skipping desktop-specific animations on mobile to improve performance");
